...
//                .setCredentialProvider(sessionCredentialsProvider)
        ...
        String consumerGroup = "test_topic_consumer_group";
        ...
        PushConsumer pushConsumer = provider.newPushConsumerBuilder()
                ...
                .setConsumerGroup(consumerGroup) // 设置消费者分组，需在rocketmq中预先配置
                .setSubscriptionExpressions(subscriptionExpressionMap)// 设置预绑定的订阅关系。
                .setConsumptionThreadCount(2) // 消费者线程数。默认20
                .setMaxCacheMessageCount(1024) // 本地缓存消息数量 默认1024，
